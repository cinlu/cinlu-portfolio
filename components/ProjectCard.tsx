...
function ProjectCard(props: Project) {
  ...
  return (
    <div
      className="h-80 p-5 mx-3 mb-6 flex flex-col justify-center items-center rounded-md shadow-lg cursor-pointer"
    ...
    >
      ...
      <div className="flex justify-center items-center">
        {props.technologiesUsed.map((tool, index) => (
          <div
            key={index}
            className="text-center font-medium mx-1 border-2 border-blue p-1 bg-cyan rounded-lg"
          >
            {tool}
          </div>
        ))}
